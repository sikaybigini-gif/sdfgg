...
(function () {
  ...
  const EN = {
    ...
    "Oku": "Read",
    "Aracı": "Medium",
    "Ruh tahtasıyla ölülerle konuştun.": "You spoke with the dead through the spirit board.",
    "TAHTA CEVAP VERDİ ▸": "THE BOARD ANSWERED ▸",
    "Plançet titredi ve baştan kaydı…": "The planchette shuddered and slid back to the start…",
    "Harfler bir emir heceliyor. Yanlış dokunuşta plançet baştan kayar.": "The letters spell a command. A wrong touch resets the planchette.",
    "BAND 2 — RUH TAHTASI": "TAPE 2 — SPIRIT BOARD",
    "Tahtanın üstünde soğuk bir plançet. Parmağın kendiliğinden kayıyor.": "A cold planchette rests on the board. Your finger slides on its own.",
    "Köşede, tozun altında eski bir ruh tahtası: harfler, bir güneş, bir ay ve tek kelime — VEDA. Plançete dokunduğun an buz gibi oluyor ve parmağının altında kendiliğinden kaymaya başlıyor. Sekiz izleyen aynı anda fısıldıyor. Bırak seni yönlendirsinler; harfleri sırayla topla, sana bir uyarı heceleyecekler.": "In the corner, under the dust, an old spirit board: letters, a sun, a moon, and one word — FAREWELL. The moment you touch the planchette it turns to ice and begins to glide on its own beneath your finger. Eight watchers whisper at once. Let them guide you; gather the letters in order and they will spell you a warning.",
    "İPUCU: Plançetin gitmek istediği harfe dokun — doğru sırayı ruhlar bilir. Yanlış harf tahtayı sıfırlar. (Aranan: 5 harf)": "HINT: Touch the letter the planchette wants — the spirits know the order. A wrong letter resets the board. (Seeking: 5 letters)",
    "Plançeti bırak, geri çekil": "Let go of the planchette, pull back",
    "BAND 2 — MESAJ ALINDI": "TAPE 2 — MESSAGE RECEIVED",
    "Plançet tek kelime bıraktı: BAKMA. Sonra durdu.": "The planchette left one word: DON'T LOOK. Then it stopped.",
    "Plançet son harfte durdu ve tahtaya kazınmış gibi kaldı: B-A-K-M-A. Ekran bir an karla doldu, sonra sekiz ses aynı anda sustu. Ayna odasına gelirsen ne demek istediklerini anlayacaksın — yansımana asla bakma. Tahtanın altında bir tebeşir parçası buldun.": "The planchette stopped on the last letter and stayed as if carved into the board: D-O-N-T L-O-O-K. The screen filled with snow for a moment, then all eight voices went silent at once. When you reach the mirror room you'll understand what they meant — never look at your reflection. Under the board you found a piece of chalk.",
    "Ruhlar seni uyardı.": "The spirits warned you.",
    "Çıkışı aramaya devam et": "Keep searching for the exit",
    "Mühürlü kapıya yönel": "Head for the sealed door",
    "Köşedeki tozlu ruh tahtasına yaklaş": "Approach the dusty spirit board in the corner",
    "Ruhların dediğini yap: gözlerini kapat, bakmadan geç": "Do as the spirits said: close your eyes, pass without looking",
    "BAND 4 — GÖZLER KAPALI": "TAPE 4 — EYES SHUT",
    "Ruhların uyarısı doğruymuş. Bakmadın. Yansıma seni tutamadı.": "The spirits' warning was true. You didn't look. The reflection couldn't hold you.",
    "Ruh tahtasındaki uyarıyı hatırladın: BAKMA. Gözlerini sıkıca kapatıp elini duvarda gezdirerek ilerledin. Aynadaki şey camı tırmaladı, adını fısıldadı, yalvardı — ama sen bakmadın. Bakmayınca seni tutamadı. Parmakların soğuk bir kapı koluna değdi: ön kapı.": "You remembered the warning from the spirit board: DON'T LOOK. Eyes squeezed shut, you moved forward with a hand along the wall. The thing in the mirror clawed the glass, whispered your name, begged — but you didn't look. Because you didn't, it couldn't hold you. Your fingers met a cold door handle: the front door.",
    "Yansımaya bakmadan geçtin.": "You passed without looking at the reflection.",
    "Ön kapıya çık": "Step out to the front door",
    "arkana bakma": "don't look back",
    "sekiz": "eight",
    "hâlâ buradayız": "we're still here",
    "kaseti geri sar": "rewind the tape",
    "sen de bizimlesin": "you're with us now",
